...
static std::string const c_childsDaoTheft =
R"E(
{
"accounts": [
	{
	...
	},
	{
		...
		"balance" : "38d1b35fd4a7f1b54f13",
		"extraBalance" : "0"
	}]
})E";

dev::Addresses const dev::eth::childDaos()
{
	Addresses accounts;
	json_spirit::mValue val;
	json_spirit::read_string(c_childsDaoTheft, val);
